...
function Experience() {
    return (
        <div className='px-10 mt-10 lg:mt-40 relative w-full flex flex-col items-center justify-center min-h-screen'>
            ...
            <div className="text-center mt-6 lg:mt-20 lg:ml-20">
                <p className='text-lg lg:text-3xl font-bold text-experience'>Experience RUBEX for free!</p>
            ...
            <button className='h-8 lg:h-16 lg:absolute lg:bottom-20 bg-buttonBg text-white mt-6 lg:mt-10 transform lg:-translate-x-1/3 lg:-ml-4 left-1/2 rounded-xl text-xs lg:text-2xl px-6 lg:px-24'>Take my free class now!</button>
