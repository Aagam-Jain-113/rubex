    ...
    return (
        <div>
            ...
            <div className='mt-20 min-h-screen'>
                <p className='text-4xl font-bold uppercase text-center'>Contact Us</p>
                <div className='grid grid-cols-2 gap-10 px-10 lg:px-28'>
                    <div className='col-span-1 mt-10'>
                        <p className='text-primary text-3xl font-semibold'>Drop us a line</p>
                        <p className='text-textSecondary text-xl mt-6'>Enter your details so we may contact you</p>
            ...
            <div className='w-10/12 rounded-3xl mt-10 mb-20 grid grid-cols-3 mx-auto shadow-cards'>
                <div className='col-span-1'>
                    <img src={Office} alt="" className='rounded-l-3xl' />
                </div>
                <div className='col-span-2 text-xl text-textSecondary p-10'>
                    <p className='font-bold'>Headoffice</p>
                    <p className='w-3/4 mt-3'>C - 2/19, Shiv shakti Apartments, sector 71 Noida, Utar Pradesh 201301</p>
